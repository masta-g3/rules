...
- Native Pi forks clear the workflow indicator and ticket context. Hub's **Fork and compact** explicitly clears inherited ticket, attention, workflow, plan, and focus state before compaction; that reset survives resume. Use matching updated Hub and installed Rules extensions. Ordinary Hub `f` uses CLI startup semantics and does not request this reset.
